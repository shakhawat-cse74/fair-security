...
@section('body')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0">Management List</h3>
            <a href="{{ route('management.create') }}" class="btn btn-danger">
...
$(document).ready(function () {
    ...
    let table = $('#management-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('management.data') }}",
        columns: [
            ...
            },
            {
                data: 'action',  
                render: function(data, type, row) {
                    let editUrl = `/management/${row.id}/edit`;
                    let deleteUrl = `/management/${row.id}`;
                    return `
