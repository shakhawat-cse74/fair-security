...
@section('body')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('partners.create') }}" class="btn btn-danger">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered text-nowrap border-bottom" id="partners-table">
                    <thead>
                        <tr>
                            <th>SL No</th>
                            <th>Company Name</th>
    ...
    let table = $('#partners-table').DataTable({
        ...
        columns: [
            ...
            },
            {
                data: 'action',  
                render: function(data, type, row) {
                    let editUrl = `/partners/${row.id}/edit`;
                    let deleteUrl = `/partners/${row.id}`;
                    return `
