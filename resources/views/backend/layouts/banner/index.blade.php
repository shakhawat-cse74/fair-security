...
@section('body')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0">Banner List</h3>
            <a href="{{ route('banners.create') }}" class="btn btn-danger">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered text-nowrap border-bottom" id="banners-table">
                    <thead>
                        <tr>
                            <th>SL No</th>
                            <th>Title</th>
    ...
    let table = $('#banners-table').DataTable({
        ...
        columns: [
            ...
            },
            {
                data: 'action',  
                render: function(data, type, row) {
                    let editUrl = `/banners/${row.id}/edit`;
                    let deleteUrl = `/banners/${row.id}`;
                    return `
