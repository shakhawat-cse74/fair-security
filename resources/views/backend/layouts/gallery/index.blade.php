...
@section('body')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('galleries.create') }}" class="btn btn-danger">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered text-nowrap border-bottom" id="galleries-table">
                    <thead>
                        <tr>
                            <th>SL No</th>
                            <th>Title</th>
...
$(document).ready(function () {
    ...
    let table = $('#galleries-table').DataTable({
        ...
        columns: [
            ...
            },
            {
                data: 'action',  
                render: function(data, type, row) {
                    let editUrl = `/galleries/${row.id}/edit`;
                    let deleteUrl = `/galleries/${row.id}`;
                    return `
    ...
    $(document).on('change', '.toggle-status', function () {
        ...
        let url = "{{ route('galleries.updateStatus', ':id') }}";
